...
class Clip : MonoBehaviour {
	...
	private void Update() {
		...
		if (Input.GetKey(KeyCode.Mouse0) && !locked && clip > 0) StartCoroutine(Charge());
	}
	...
	/*
	spins, missing ammo fills, dot appears, color charges
	upon ready, reverse reload anim
	upon cancel, spins back
	*/
